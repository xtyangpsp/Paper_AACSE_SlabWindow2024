...
set Gd_list = inv_Gd_list_4x4x10.ori
...
#set datafile = measure_result.dat
#cat /dev/null > dataerror_list
#foreach phase (`cat $datafile | awk '{print $1}'`)
#cat $datafile | grep $phase | awk '{print $8}' >> dataerror_list
#end
...
#@ nd = 0
#echo > inv_Gd_list
cat /dev/null > inv_Gd_list_4x4x10_0
foreach tt ( `cat $Gd_list | awk '{print $1}'` )
#@ nd = $nd + 1
#set ttid = "num"$nd
...
echo $tt $c2 $ttwithnoise $c4 $c5 $c6 $c7 $c8 $c9 $c10 $c11 $c12 $c13 >> inv_Gd_list_4x4x10_0
#>> inv_Gd_list
end
