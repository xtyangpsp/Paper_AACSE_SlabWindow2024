...
def main():
    ...
    ## Global parameters
    rootpath  = "/depot/xtyang/data/projects/vsassard/AACSE_imaging/stack_merge"   # root path for this data processing
    splitpath = "/depot/xtyang/data/projects/vsassard/AACSE_imaging/splitting"                         
    MERGEDIR  = os.path.join(rootpath,'PAIRS_TWOSIDES')                          # dir where stacked data is going to
    SPLITDIR    = os.path.join(splitpath,'PAIRS_SPLIT_SIDES')                            # dir where CC data is stored
