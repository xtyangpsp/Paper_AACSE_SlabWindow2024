...
def main():
    ...
    ## Global parameters
    rootpath = "/home/vsassard/DEPOTVINCE/AACSE_imaging"                                 # root path for this data processin
    INDIR  = os.path.join(rootpath,'stack_merge/PAIRS_TWOSIDES')                          # dir where stacked data is going to
    OUTDIR = os.path.join(rootpath,'shaping_wavelet')
    ...
    OUTDIR_ROOT    = OUTDIR+"_"+wavelet+"_a"+str(wave_width)+"t"+str(wave_shift)
